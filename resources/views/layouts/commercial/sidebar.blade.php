    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="dropdown @if($table == 'dachboard')  active @endif">
                <a href="/commercial/dachboard" class="nav-link "><i class="fas fa-fire"></i><span>Accueil</span></a>
            </li>
            ...
            <li class="dropdown @if($table == 'familles')  active @endif">
                ...
                <ul class="dropdown-menu">
                    <li class="@if($table == 'familles')  active @endif"><a href="{{route('commercial.familles')}}" class="nav-link" href="/familles">list du Famille (c)</a></li>

                    <li><a class="nav-link beep beep-sidebar" href="{{route('commercial.create')}}">Ajoutee Famille</a></li>
                </ul>
            </li>
        ...
        <div class=" mb-4 p-3 hide-sidebar-mini">
            ...
            <a href="{{route('commercial.logout')}}" class="btn btn-primary btn-lg btn-block btn-icon-split" style="background-color: white ;border-color: #fff;color:#ff2727;"><i class="fas fa-power-off "></i>Logout</a>
        </div>
    </aside>
</div>