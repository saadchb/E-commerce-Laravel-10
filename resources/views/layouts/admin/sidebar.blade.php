    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="dropdown @if($table == 'dachboard')  active @endif">
                <a href="/admin/dachboard" class="nav-link "><i class="fas fa-fire"></i><span>Accueil</span></a>
            </li>
        ...
        <div class=" mb-4 p-3 hide-sidebar-mini">
            ...
            <a href="{{route('login.logout')}}" class="btn btn-primary btn-lg btn-block btn-icon-split" style="background-color: white ;border-color: #fff;color:#ff2727;"><i class="fas fa-power-off "></i>Logout</a>
        </div>
    </aside>
</div>