                ...
                <div class="product-category grid-style">
                    ...
                    <div class="row">
                        <ul class="products-list">
                            ...
                            @if ($soFam->famille_id == $famille->id and $item->sous_famille_id == $soFam->id and $soFam->active == 1)
                            <li class="product-item col-lg-4 col-md-4 col-sm-4 col-xs-6">
                                <div class="contain-product layout-default">
                                    ...
                                    <div class="info">
                                        <b class="categories">{{$soFam->libelle}}</b>
                    ...
                    <div class="widget biolife-filter">
                        ...
                        <div class="wgt-content">
                            <ul class="cat-list">
                                <ul class="products-list">
                                    @foreach ($sous_famille as $soFam)
                                    @if ($soFam->famille_id == $famille->id)
                                    <li class="cat-list-item"><a href="{{route('sousfamilleDetail',$soFam->id)}}" class="cat-link">{{$soFam ->libelle}}</a></li>
                                    @endif
                                    @endforeach
                                </ul>
                        </div>
